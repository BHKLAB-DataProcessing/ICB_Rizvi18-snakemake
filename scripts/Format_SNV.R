...
data = cbind( snv[ , c("Start_Position" , "Tumor_Sample_Barcode" , "Hugo_Symbol", "Variant_Classification" ) ] ,
...
data$Sample = sapply( data$Sample , function(x){ unlist( strsplit( x , "-T" , fixed=TRUE ))[1] } )
